...
import '../style/Men.scss';  // 스타일 파일은 별도로 생성해 주세요.
import Menu from './Menu';
import menData from '../data/Rank-Men.json';  // Men 데이터를 불러오는 경로 (데이터 파일 경로 수정 필요)
        ...
        {loading ? (
          ...
          getFilteredData().length > 0 ? (
            getFilteredData().map((item, index) => (
              <li key={item.id} className="rank-item-men">
